...
const Psychologists = () => {
  ...
  const newArray = data.map((obj) => {
    return {
      ...
      href: "/psychology/psychologyadults/depression/" + obj.name.replace(/\s+/g, "-"),
    };
  });
  /**Data Comment */

  return (
    <Box py={5} mt={16} className="psychologists">
      <Container maxWidth="lg">
        ...
        <Box mt={4} className="d-flex justify-center">
          <Link href="/psychology/psychologyadults/depression">
