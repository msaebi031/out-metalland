            ...
            >
                {data.map((event, index) => (
                    <SwiperSlide key={index}>
                        <Card className="card-box align-cenrter">
                            <Avatar className="avatar" alt="Travis Howard" src={event.img} />
                            <CardContent className="content">
                                <Typography color="primary.main" component="h6" variant="h6">
                                    {event.name}
                                </Typography>
                                <Box className="d-flex justify-between" py={1.7}>
                                    <Typography color="primary.main" component="p" variant="body1">{event.date}</Typography>
                                    <Typography color="primary.main" component="p" variant="body1">{event.job}</Typography>
                                </Box>
